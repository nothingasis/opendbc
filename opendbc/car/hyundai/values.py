...
class CAR(Platforms):
  ...
  KIA_CARNIVAL_HEV_4TH_GEN = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia Carnival Hybrid 2025", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_a])),
    ],
    CarSpecs(mass=2302, wheelbase=3.09, steerRatio=14.23),
